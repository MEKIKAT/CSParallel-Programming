...
try:
    ...
    if int(cons_type) >= 3:
        ...
        prewat = float(input("Previews Wattage : "))
        ...
        if curwat > prewat:
            ...
            if int(cons_type) == 0:
                ...
                print('Oopps some thing went wrong !!')
        else:
            print('Current wattage should be Higher ')
            
    
except ValueError:
    print("Input is not in Choices, Alphabets are invalid ")
